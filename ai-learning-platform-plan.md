...
13. **Prompt Engineering** — few-shot, chain-of-thought, system prompts (split out from the old combined "Applied / Agentic Systems" lesson — each of 13–16 now independently SEO-targetable)
14. **RAG & Vector Databases** — retrieval, embeddings, similarity search, ANN indexes
