...
**Status: MVP v1 shipped and live on Vercel.** 18 lessons written, 13 widgets shipped (every lesson has at least one), reference glossary with auto-linking + backlinks shipped, People collection (22 profiles), FAQ hub page, and a full homepage/theme redesign.
